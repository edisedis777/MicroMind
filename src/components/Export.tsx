  ...
  return (
    <div className="py-6 space-y-6">
      <div className="text-center space-y-2">
        <h2 className="text-2xl font-semibold text-stone-900">Export Journal</h2>
      ...
      {/* Stats */}
      <div className="p-6 rounded-xl text-center bg-white">
        ...
        <div className="space-y-4">
          {exportOptions.map(({ format, icon: Icon, title, description, color }) => (
            <button
              ...
              className={`w-full p-6 rounded-xl border text-left transition-all duration-200 bg-white border-stone-200 hover:border-stone-300 hover:bg-stone-50 ${
            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-lg mb-1 text-stone-900">
