...
export function Settings() {
  ...
  const totalWords = entries.reduce((total, entry) => {
    return (
      total + (entry.learned + entry.question + entry.idea).split(" ").length
    );
  }, 0);
    ...
    <div className="py-6 space-y-6">
      ...
      <div className="p-6 rounded-xl bg-white">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-stone-500">Words Written</div>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 rounded-xl bg-white">
        ...
        <div className="text-sm space-y-4 text-stone-600">
          <p>
            MicroMind is designed to help you build a powerful daily reflection
            habit through three simple but transformative questions. Research
            shows that regular reflection enhances learning retention, promotes
            self-awareness, and accelerates personal growth.
          </p>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-xs">
                  Answer three focused questions each day to capture learning,
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-xs">
                  Your thoughts are automatically saved as you type - never lose
                  an insight again
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-xs">
                  View your reflection history, maintain streaks, and see your
                  growth over time
                </p>
              </div>
            </div>
          ...
          <div className="pt-2 border-t border-stone-100">
            ...
            <div className="space-y-1 text-xs">
              <p>
                <span className="font-medium">📚 What did I learn?</span> -
                Reinforces knowledge and identifies growth
              </p>
              <p>
                <span className="font-medium">❓ What question do I have?</span>{" "}
                - Cultivates curiosity and critical thinking
              </p>
              <p>
                <span className="font-medium">💡 What idea came to mind?</span>{" "}
                - Captures creativity and insights
              </p>
            </div>
          </div>
          ...
          <div className="pt-2 border-t border-stone-100">
            <p className="text-xs">
              <strong>Why it works:</strong> Just 5 minutes of daily reflection
              can significantly improve learning retention, self-awareness, and
              decision-making. Small, consistent habits create lasting
              transformation.
            </p>
          </div>
          ...
          <div className="flex items-center space-x-2 pt-2">
            ...
            <span>by reelikklemind.com</span>
          </div>
        </div>
      </div>
    </div>
